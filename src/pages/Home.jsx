  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative bg-primary-600 text-black min-h-screen flex items-center">
        ...
        {/* Hero Image with Lazy Load + Blur Effect */}
        <img
          src={heroImage}
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                To empower residents of underserved communities by providing
                access to healthcare, environmental solutions, and economic
                opportunities, thereby enhancing quality of life and promoting
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                To foster healthier, more educated, and environmentally
                sustainable communities through integrated youth-led
